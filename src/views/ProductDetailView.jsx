...
const ProductDetailView = () => {
  ...
  if(error){
    return (<p>Hubo un error, vuelva a intentarlo</p>)
  }
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <div className="flex border-t border-b mb-6 border-gray-200 py-2">
          ...
          <span className="ml-auto text-gray-900"><CircleColor color={color}/></span>
        </div>
        <div className="flex">
    ...
    <div className="container px-5 py-24 mx-auto">
      ...
      <h2 className="text-xl mb-5">Opiniones</h2>
      <textarea className="border-3 rounded w-full mb-3 outline p-3" placeholder="Deja tu comentario aqui...">
      </textarea>
        {opiniones.length > 0 ? opiniones.map((opinion,i) => (
          <div className="w-full p-3 border-2 rounded mb-4" key={i}>
            {opinion}
          </div>
        )) : <p className="w-full p-3 border-2 mb-4">No se encontraron opiniones</p>}
      </div>
    </div>
  </div>
</section>
